...
Drupal Next Accelerator theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
#### Step 2
Go to the root of Drupal Next Accelerator theme and run the following commands:
`nvm use`
